            ...
            <div class="search-field d-none d-md-block">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control" name="slsearch" id="slsearch">
                        @if(isset($_GET['slsearch']))
                            @if($_GET['slsearch'] == "stour")
                                <option value="stour" selected>Tour</option>
                                <option value="sgroup">Group</option>
                                <option value="scus">Customer</option>
                            @elseif($_GET['slsearch'] == "sgroup")
                                <option value="stour">Tour</option>
                                <option value="sgroup" selected>Group</option>
                                <option value="scus">Customer</option>
                            @elseif($_GET['slsearch'] == "scus")
                                <option value="stour">Tour</option>
                                <option value="sgroup">Group</option>
                                <option value="scus" selected>Customer</option>
                            @endif
                        @else
                            <option value="stour" selected>Tour</option>
                            <option value="sgroup">Group</option>
                    ...
                    <input type="text" class="form-control bg-transparent border-0" name="valuesearch" id="valuesearch" placeholder="Search" value="">
                </div>
                </form>
            </div>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="tourprice">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="/tourprice/listprc"> List </a></li>
                        <li class="nav-item"> <a class="nav-link" href="/tourprice/addprc"> Add </a></li>
                    </ul>
                    </div>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#summany" aria-expanded="false" aria-controls="summany">
                    <span class="menu-title">Summany</span>
                    <i class="menu-arrow"></i>
                    <i class="mdi mdi-medical-bag menu-icon"></i>
                    </a>
